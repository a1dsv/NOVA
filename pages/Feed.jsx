...
import { Camera, Heart, MapPin, Plus, X, Upload, Image as ImageIcon } from 'lucide-react';
        ...
        <div className="sticky top-0 z-20 bg-black/90 backdrop-blur-xl border-b border-white/5">
          <div className="px-4 py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold nova-gradient-text">FEED</h1>
                <p className="text-white/40 text-xs uppercase tracking-widest">Community Captures</p>
              </div>
              <Button
